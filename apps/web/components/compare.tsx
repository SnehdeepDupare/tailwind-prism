...
export const Compare = ({
  ...
  const handleTouchStart = useCallback(
    ...
    [handleStart, autoplay, stopAutoplay]
  );
  ...
  }, [handleEnd, autoplay, stopAutoplay, startAutoplay]);
    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          ...
          <div className="absolute top-1/2 -right-10 h-3/4 w-10 -translate-y-1/2 mask-[radial-gradient(100px_at_left,white,transparent)]"></div>
          {showHandlebar && (
